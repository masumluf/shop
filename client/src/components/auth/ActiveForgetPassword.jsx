    ...
    try {
      ...
      if (result) {
        ...
        setValues({
          ...values,
          buttonText: "Submit",
          activationMessage: "Password Has Been Changed",
      ...
      setValues({
        ...values,
        activationMessage: "Invalid Token Found",
        buttonActivation: false,
      ...
      {boxStatus && (
        <div className='form-group'>
          ...
          <input
            ...
            type='password'
            className={
              error.repassword ? " form-control is-invalid" : " form-control"
            }
          />
          <div className=' invalid-feedback'>{error.repassword}</div>
        </div>
      )}
